...
const catsExplanation: CatsExplanation[] = [
    ...
    },
    {
        ...
        <ul>
            <li>Test Case 1: Check Bed Comfiness<ul>
                    <li>Steps:<ol>
            ...
            <li>Test Case 2: Check Food Bowl<ul>
                    <li>Steps:<ol>
            ...
            <li>Test Case 3: Check Scratching Post Strength<ul>
                    <li>Steps:<ol>
            ...
            <li>Test Case 4: Check Window View<ul>
                    <li>Steps:<ol>
            ...
            <li>Test Case 5: Check Litter Box Cleanliness<ul>
                    <li>Steps:<ol>
        ...
        <ol>
            <li>
                ...
                <ul>
                    ...
                    <li><strong>Defect Life Cycle:</strong>This is the journey of a defect from when it&rsquo;s found to when it&rsquo;s fixed.<ul>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>
                ...
                <ul>
                    <li><strong>GET Request:</strong>Indy sends a message to Grey asking for the current status of the food bowl. In Postman, this is done by creating a GET request.<ul>
                    ...
                    <li><strong>POST Request:</strong>Grey sends a message to Indy to update the status of the scratching post. In Postman, this is done by creating a POST request.<ul>
            ...
            <li>
                ...
                <ul>
                    <li>Indy and Grey take on a challenge to test a sample API. They create test cases for different API endpoints (places where they send messages).<ul>
        ...
        <ol>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><strong>Tutorial Example:</strong>They see examples of simple commands like:<ul>
            ...
            <li>
                ...
                <ul>
                    <li>Indy and Grey practice writing and executing SQL queries. They try out five basic queries:<ul>
            ...
            <li>
                ...
                <ul>
                    <li>Indy and Grey take on a challenge to test the database. They perform various tasks like finding, adding, updating, and deleting entries.<ul>
                            <li><strong>Challenge Task 1:</strong>Find all the activities related to toys.<ul>
                                    <li><strong>Query:</strong><code>SELECT * FROM activities WHERE description LIKE &apos;%toy%&apos;;</code></li>
                                </ul>
                            </li>
                            <li><strong>Challenge Task 2:</strong>Add a new activity about catching a mouse.<ul>
                                    <li><strong>Query:</strong><code>INSERT INTO activities (description, date) VALUES (&apos;Caught a mouse&apos;, &apos;2024-08-04&apos;);</code></li>
                                </ul>
                            </li>
                            <li><strong>Challenge Task 3:</strong>Update the status of the scratching post activity to &quot;repaired.&quot;<ul>
                                    <li><strong>Query:</strong><code>UPDATE activities SET status = &apos;repaired&apos; WHERE description = &apos;Scratching post&apos;;</code></li>
                                </ul>
                            </li>
                            <li><strong>Challenge Task 4:</strong>Delete the entry about a spilled water bowl.<ul>
                                    <li><strong>Query:</strong><code>DELETE FROM activities WHERE description = &apos;Spilled water bowl&apos;;</code></li>
                                </ul>
                            </li>
                            <li><strong>Challenge Task 5:</strong>Find all activities logged in the past week.<ul>
        ...
        <ol>
            <li>
                ...
                <ul>
                    ...
                    <li><strong>Algorithm:</strong>A series of steps or instructions to solve a problem.<ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><strong>Git:</strong>A tool to manage and track changes in code.<ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><strong>HTML (HyperText Markup Language):</strong>The language used to create webpages.<ul>
    ...
    <ol>
        ...
        <li>
            ...
            <ul>
                ...
                <li><strong>Example Task:</strong>Indy and Grey create a simple script to automate checking if their favorite cat toy website is up and running.<ul>
        ...
        <li>
            ...
            <ul>
                ...
                <li><strong>Task:</strong>Automate a login process on the website.<ul>
        ...
        <ol>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><strong>User Guide Example:</strong>They learn about key features like:<ul>
